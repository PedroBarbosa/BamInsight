...
setup(
    ...
    version = "0.1",
    packages=["Main"],    # top-level python modules you can import like
                                #   'import foo'
    ...
    description = "A Useful bioinformatic tool to quickly vizualize your data in Genome Browser UCSC",
    license = "BSD",
    keywords= "Genome Bowser UCSC tool",
    url = "https://github.com/rluis/BamInsight",
    entry_points = {
        "console_scripts": [        # command-line executables to expose
            "baminsight = Main.main:main",
        ],
